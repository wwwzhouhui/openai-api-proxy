...
export function cerebras(env: Record<string, string>) {
  ...
  //   'cerebras/deepseek-r1-distill-llama-70b': 'cerebras/deepseek-r1-distill-llama-70b',
  // }
  const r = openaiBase({
    createClient: () =>
      new OpenAI({
  ...
  r.supportModels = ['llama-3-70b', 'llama-3-8b', 'qwen-3-235b-a22b-instruct-2507', 'qwen-3-235b-a22b-thinking-2507', 'qwen-3-coder-480b', 'qwen-3-32b', 'gpt-oss-120b', 'cerebras/deepseek-r1-distill-llama-70b']
  return r
}
